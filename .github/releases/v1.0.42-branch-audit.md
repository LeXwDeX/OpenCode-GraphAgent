...
- Candidate PR #577 preserves that source commit as an ancestor, includes the main history, and retains all seven Goal issue closing references plus #576. Product content after the integration merge is identical to the verified Goal source; subsequent candidate changes are release documentation.
